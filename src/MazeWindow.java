...
public class MazeWindow extends Application {
    ...
    private MenuItem red, orange, yellow, green, blue, purple, maze1, maze2, maze3, maze4, maze5, loadMaze, write, rhlar, lhlar, rhr, lhr, rr, rlahr, rmr, lmr, rlhmr, llhmr, mc;
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        robot.getItems().addAll(rhr, lhr, rr, rhlar, lhlar, rlahr, rmr, lmr, rlhmr, llhmr);
